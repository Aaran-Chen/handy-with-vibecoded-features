...
#[tauri::command]
#[specta::specta]
pub fn change_collapse_animation_enabled_setting(
    app: AppHandle,
    enabled: bool,
) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.collapse_animation_enabled = enabled;
    settings::write_settings(&app, settings);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_collapse_animation_speed_setting(app: AppHandle, speed: f64) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.collapse_animation_speed = speed.clamp(0.25, 3.0);
    settings::write_settings(&app, settings);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_clipboard_fallback_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.clipboard_fallback = enabled;
    settings::write_settings(&app, settings);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_context_aware_enabled_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.context_aware_enabled = enabled;
    settings::write_settings(&app, settings);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn update_context_tone_rules(
    app: AppHandle,
    rules: Vec<crate::settings::ToneRule>,
) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.context_tone_rules = rules;
    settings::write_settings(&app, settings);
    Ok(())
}
